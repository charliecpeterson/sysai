...
| `web_search` | auto | Search the web via [Jina Search](https://jina.ai/search-foundation/) and return full extracted page content — not just snippets. No API key needed. Disabled when `SYSAI_NO_JINA=1`. |
